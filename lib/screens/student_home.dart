  ...
  Widget buildProjectCard(String title, IconData icon, BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        if (title == "Home Going") {
          Navigator.push(context, MaterialPageRoute(builder: (context) => HomeGoingScreen()));
        }
        if (title == "Out Going") {
          Navigator.push(context, MaterialPageRoute(builder: (context) => OutGoingScreen()));
        }
        if (title == "Permission") {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => StudentComplaintScreen(
                studentRegNo: registernumber,  // Pass correct register number
                studentName: username,         // Pass correct student name
              ),
            ),
          );
        }
